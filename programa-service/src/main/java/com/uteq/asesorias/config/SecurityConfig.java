...
// JWT security for programa-service
        ...
        @Override protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws ServletException, IOException {
            ...
            if (auth!=null && auth.startsWith("Bearer ")){
                try{
                    ...
                    System.out.println("[programa-service] JWT parsed OK for subject: " + claims.getSubject() + ", roles=" + roles);
                }catch(Exception ex){
                    System.out.println("[programa-service] JWT parse FAILED: " + ex.getMessage());
                }
            } else {
                System.out.println("[programa-service] No Authorization Bearer token on " + request.getMethod() + " " + request.getRequestURI());
            }
